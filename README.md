# messaging-intel-test/security-boundary-tests
...
This repository is the `security` deep-test suite for `messaging-intel`. It is intentionally dependency-light and deterministic so failures can be reproduced locally without production credentials or customer data.
